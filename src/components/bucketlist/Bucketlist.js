          ...
          {Bucketlist !== null ? (
            isSubmitted ? (
                  ...
                  return (
                    <div className="site-container" key={uuid()}>
                      ...
                      <div
                        ...
                        onClick={() => {
                          removeTaskFromLocalStorages(item);
                        }}
                      >
                        Remove
                      </div>
              ...
              <div className="bucketempty">
                Kindly login to View Bucket List
              </div>
            )
          ) : (
            <div className="bucketempty">
              Your BucketList is empty or kindly login to check your bucketlist
            </div>
          )}
        </div>
      </section>
